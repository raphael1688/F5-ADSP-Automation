...
| UC2 | NGINX Ingress Controller with NGINX App Protect on GKE, NGINX One for fleet management, F5 Distributed Cloud with API security on top | GCP | _in progress_ |
